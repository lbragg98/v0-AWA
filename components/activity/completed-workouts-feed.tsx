    ...
    <div className="space-y-4">
      {workouts.map((workout) => (
        <Link key={workout.id} href={`/app/activity/${workout.id}`}>
          <Card className="group relative cursor-pointer overflow-hidden border-white/8 p-5">
            <div className="absolute bottom-5 left-6 top-5 w-px bg-[linear-gradient(180deg,rgba(83,193,255,0.45),transparent)] opacity-60" />
            <div className="space-y-4 pl-4">
              <div className="flex items-start justify-between gap-3">
                <div className="min-w-0 flex-1">
                  <p className="mb-1 text-[11px] font-semibold uppercase tracking-[0.22em] text-primary/75">Completed Session</p>
              ...
              <div className="grid grid-cols-3 gap-3 text-sm">
                <div className="rounded-2xl border border-white/8 bg-white/[0.04] p-3 text-muted-foreground">
                  <div className="flex items-center gap-2">
